...
- Configurable prompt templates for `rewrite` and `summarize`
...
- The active AI backend currently supports only `rewrite` and `summarize`.
...
- Additional AI actions beyond `rewrite` and `summarize`
...
- backend AI streaming foundation with persisted history and decision tracking
